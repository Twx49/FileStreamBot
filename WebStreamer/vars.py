...
class Var(object):
    ...
    BIN_CHANNEL = int(getenv('BIN_CHANNEL','-2230895398'))
    ...
    UPDATES_CHANNEL = str(getenv('UPDATES_CHANNEL','-2232186680'))
    BANNED_CHANNELS = list(set(int(x) for x in str(getenv("BANNED_CHANNELS", "-2162697115")).split()))
